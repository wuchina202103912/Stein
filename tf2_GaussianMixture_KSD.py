...
G_W1 = tf.compat.v1.get_variable('g_w1', [z_dim, h_dim_g], dtype=tf.float32, initializer=initializer)
G_b1 = tf.compat.v1.get_variable('g_b1', [h_dim_g], initializer=initializer)
G_W2 = tf.compat.v1.get_variable('g_w2', [h_dim_g, h_dim_g], dtype=tf.float32, initializer=initializer)
G_b2 = tf.compat.v1.get_variable('g_b2', [h_dim_g], initializer=initializer)
G_W3 = tf.compat.v1.get_variable('g_w3', [h_dim_g, X_dim], dtype=tf.float32, initializer=initializer)
G_b3 = tf.compat.v1.get_variable('g_b3', [X_dim], initializer=initializer)
